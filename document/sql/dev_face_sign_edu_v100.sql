...
CREATE TABLE `attendance_record`  (
  `id` bigint NOT NULL COMMENT '唯一ID号',
  `student_id` bigint NOT NULL COMMENT '关联学生表的外键',
  `course_id` bigint NOT NULL COMMENT '关联课程表的外键',
  `schedule_id` bigint NOT NULL COMMENT '关联课程安排表的外键',
...
CREATE TABLE `course`  (
  ...
  `teacher_id` bigint NOT NULL COMMENT '关联教师表的外键',
  `class_id` bigint NOT NULL COMMENT '关联班级表的外键',
...
CREATE TABLE `student`  (
  ...
  `class_id` bigint NOT NULL COMMENT '班级ID，关联班级表',
